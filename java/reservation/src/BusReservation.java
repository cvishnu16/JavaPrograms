...
return false;
} else {totalSeatsAvailable = totalSeatsAvailable-seats;System.out.println("totalseats available "+Thread.currentThread().getName()+" "+totalSeatsAvailable);return true;
}
}
